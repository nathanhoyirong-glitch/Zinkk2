...
published as presence, not verified by the server. This keeps things
simple and low-latency for a casual game, but it isn't cheat-proof -- a
modified client could report false damage, position, or captures. Good
enough for playing with friends; not meant for a public, competitive
deployment.
