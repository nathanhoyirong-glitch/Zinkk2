...
//
// Serves index.html (in this same folder) as a static file and runs a
...
// they can't run server.js, only serve index.html.
...
app.get('/', (req, res, next) => {
  ...
  res.status(500).send(
    'index.html was not found next to server.js.\n' +
    'Check the repo file list on github.com -- index.html should be ' +
    'at the top level, right alongside server.js and package.json.'
  );
});
